...
var twitch = new URL()
var ajax = new Ajax(twitch.url())
var pagination = new Pagination()

twitch.on('update', function() {
  ajax.update(twitch.url())
  sessionStorage.setItem('searchTerm', twitch.qs.q);
})
...
ajax.on('get', function(jsonObj) {
  ...
  if (count === 0) {
    ...
    var noResults = $div('no_results', 'Sorry, no results for: <strong>' + twitch.qs.q + '</strong>')
